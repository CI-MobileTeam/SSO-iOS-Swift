...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://EXAMPLE/CISSO"
  ...
  # Or just: spec.author    = "Hank Chien"
  # spec.authors            = { "Hank Chien" => "hankchien@cloud-interactive.com" }
  # spec.social_media_url   = "https://twitter.com/Hank Chien"
  ...
  spec.source       = { :git => "http://EXAMPLE/CISSO.git", :tag => "#{spec.version}" }
